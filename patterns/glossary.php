<?php
/**
 * Title: Sticky glossary
 * Slug: mosne-dots/glossary
 * Categories: text
...
<div class="wp-block-group"><!-- wp:heading -->
	...
	<!-- wp:details -->
	<details class="wp-block-details"><summary>Admin Area</summary><!-- wp:paragraph {"placeholder":"Tapez / pour ajouter un bloc caché"} -->
		<p>The main control panel where you manage your WordPress website.</p>
	...
	<!-- wp:details -->
	<details class="wp-block-details"><summary>Block</summary><!-- wp:paragraph {"placeholder":"Tapez / pour ajouter un bloc caché"} -->
		<p>The main control panel where you manage your WordPress website.</p>
		<!-- /wp:paragraph --></details>
	<!-- /wp:details -->
	...
	<!-- wp:details -->
	<details class="wp-block-details"><summary>Comment</summary><!-- wp:paragraph {"placeholder":"Tapez / pour ajouter un bloc caché"} -->
		<p>A message left by a visitor in response to a post or page.</p>
		<!-- /wp:paragraph --></details>
	<!-- /wp:details -->
	...
	<!-- wp:details -->
	<details class="wp-block-details"><summary>Draft</summary><!-- wp:paragraph {"placeholder":"Tapez / pour ajouter un bloc caché"} -->
		<p>A saved post or page that is not yet publicly visible on your website.</p>
		<!-- /wp:paragraph --></details>
	<!-- /wp:details --></div>
<!-- /wp:group -->
