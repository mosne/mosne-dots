...
<div class="wp-block-comments"><!-- wp:heading {"fontSize":"medium"} -->
<h2 class="wp-block-heading has-medium-font-size"><?php esc_html_e('Comments', 'mosne-dots');?></h2>
<!-- /wp:heading -->

<!-- wp:comments-title {"level":3,"fontSize":"small"} /-->
...
<div class="wp-block-column" style="flex-basis:40px"><!-- wp:avatar {"size":40,"style":{"border":{"radius":"20px"},"color":{"duotone":"var:preset|duotone|duotone-1"}}} /--></div>
<!-- /wp:column -->
