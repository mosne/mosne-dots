...
<div class="wp-block-group"><!-- wp:post-terms {"term":"category","prefix":"Posted in ","suffix":"."} /-->

<!-- wp:post-terms {"term":"post_tag","prefix":"Tags: ","suffix":"."} /--></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<p><?php esc_html_e('Written by ', 'mosne-dots');?></p>
<!-- /wp:paragraph -->

<!-- wp:post-author {"showAvatar":false,"style":{"typography":{"textTransform":"uppercase"}}} /--></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->